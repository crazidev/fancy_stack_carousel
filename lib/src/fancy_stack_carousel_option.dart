...
enum CenterPageEnlargeStrategy { scale }
...
class FancyStackCarouselOptions {
  ...
  ///
  /// Defaults to [Curves.ease].
  final Curve animateRightCurve;

  /// Determines the right animation curve physics.
  ///
  /// Defaults to [Curves.ease].
  final Curve animateLeftCurve;
  ...
  final Function(int index, FancyStackCarouselTrigger reason)? onPageChanged;
  ...
  FancyStackCarouselOptions({
    ...
    this.animateRightCurve = Curves.ease,
    this.animateLeftCurve = Curves.ease,
  ...
  ///Generate new [FancyStackCarouselOptions] based on old ones.

  FancyStackCarouselOptions copyWith({
    double? height,
    double? aspectRatio,
    ...
    Function(int index, FancyStackCarouselTrigger reason)? onPageChanged,
    ValueChanged<double?>? onScrolled,
    ScrollPhysics? scrollPhysics,
    bool? pageSnapping,
    Axis? scrollDirection,
    bool? pauseAutoPlayOnTouch,
    bool? pauseOnMouseHover,
    ...
    pauseOnMouseHover: pauseOnMouseHover ?? this.pauseOnMouseHover,
