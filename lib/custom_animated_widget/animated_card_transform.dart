...
class AnimatedCardTransform extends ImplicitlyAnimatedWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Alignment>(
        'zRotationAlignment', zRotationAlignment));
...
class _AnimatedCardTransformState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _firstOffset = visitor(_firstOffset, widget.firstOffset,
            (dynamic value) => Tween<double>(begin: value as double))
        as Tween<double>?;
    _secondOffset = visitor(
      _secondOffset,
      widget.secondOffset,
      (dynamic value) => Tween<double>(begin: value as double),
    ) as Tween<double>?;
    ...
    _zRotationAngle = visitor(
      _zRotationAngle,
      widget.zRotationAngle,
      (dynamic value) => Tween<double>(begin: value as double),
    ) as Tween<double>?;
    _yRotationAngle = visitor(
      _yRotationAngle,
